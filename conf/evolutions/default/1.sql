...
create table "adviser" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"stuID" VARCHAR NOT NULL,"teaID" VARCHAR NOT NULL);
create table "detail" ("userID" VARCHAR NOT NULL,"topic" VARCHAR NOT NULL,"detail" VARCHAR NOT NULL,"img" VARCHAR NOT NULL);
create table "comment" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"detail" VARCHAR NOT NULL,"userID" VARCHAR NOT NULL,"projectID" VARCHAR NOT NULL));
# --- !Downs
