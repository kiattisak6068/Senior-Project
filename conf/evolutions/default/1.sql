...
create table "detailUp" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"detail" VARCHAR NOT NULL,"userID" VARCHAR NOT NULL,"lesson" VARCHAR NOT NULL,"time" VARCHAR NOT NULL);
create table "ComProject" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"detail" VARCHAR NOT NULL,"userID" VARCHAR NOT NULL,"projectID" VARCHAR NOT NULL,"lesson" VARCHAR NOT NULL);
# --- !Downs
