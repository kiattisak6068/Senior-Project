...
create table "detail" ("userID" VARCHAR NOT NULL,"topic" VARCHAR NOT NULL,"detail" VARCHAR NOT NULL,"objective" VARCHAR NOT NULL,"scope" VARCHAR NOT NULL,"technology" VARCHAR NOT NULL,"benefits" VARCHAR NOT NULL,"img" VARCHAR NOT NULL);
